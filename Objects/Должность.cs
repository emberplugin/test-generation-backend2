...
namespace IIS.WebLearning2016
{
    ...
    public class Должность : ICSSoft.STORMNET.DataObject
    {
        ...
        /// Актуально.
        /// </summary>
        //  *** Start programmer edit section *** (Должность.Актуально CustomAttributes)

        //  *** End programmer edit section *** (Должность.Актуально CustomAttributes)
        public virtual bool Актуально
        {
            get
            {
                //  *** Start programmer edit section *** (Должность.Актуально Get start)

                //  *** End programmer edit section *** (Должность.Актуально Get start)
                bool result = this.fАктуально;
                //  *** Start programmer edit section *** (Должность.Актуально Get end)

                //  *** End programmer edit section *** (Должность.Актуально Get end)
                return result;
            }
            set
            {
                //  *** Start programmer edit section *** (Должность.Актуально Set start)

                //  *** End programmer edit section *** (Должность.Актуально Set start)
                this.fАктуально = value;
                //  *** Start programmer edit section *** (Должность.Актуально Set end)

                //  *** End programmer edit section *** (Должность.Актуально Set end)
            }
        }
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДолжностьE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДолжностьE", typeof(IIS.WebLearning2016.Должность));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДолжностьL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДолжностьL", typeof(IIS.WebLearning2016.Должность));
                }
            }
        }
    }
